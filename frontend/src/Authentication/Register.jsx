...
const Register = () => {
  ...
  const handleGoogleSignUp = () => {
    setApiError('Google Sign Up will be implemented soon');
  };
      ...
      >
        ...
        <motion.div variants={itemVariants} style={styles.card}>
          <motion.div variants={itemVariants} style={styles.header}>
            ...
            <p style={styles.subtitle}>Join us and start detecting deepfakes today</p>
          </motion.div>
          ...
          <motion.form variants={itemVariants} onSubmit={handleSubmit} style={styles.form}>
            <div style={styles.inputGroup}>
              ...
              >
                <User style={{
                  ...styles.inputIcon,
                  color: focusedField === 'name' ? '#3b82f6' : '#64748b'
                }} />
                <input
                  type="text"
                  name="name"
              ...
              <label style={styles.checkboxLabel}>
                <motion.div
                  ...
                  style={{
                    ...
                    borderColor: acceptTerms ? '#10b981' : 'rgba(255, 255, 255, 0.2)',
                    background: acceptTerms ? 'rgba(16, 185, 129, 0.1)' : 'rgba(255, 255, 255, 0.05)'
                  }}
...
const styles = {
  ...
  strengthLabel: { fontSize: '0.8rem', fontWeight: 600, minWidth: '60px', textAlign: 'right' },
  errorText: { fontSize: '0.85rem', color: '#ef4444', marginTop: '0.25rem' },
  termsWrapper: { display: 'flex', flexDirection: 'column', gap: '0.5rem' },
  checkboxLabel: { display: 'flex', alignItems: 'flex-start', gap: '0.75rem', cursor: 'pointer' },
  customCheckbox: {
    width: '24px',
    height: '24px',
    flexShrink: 0,
  ...
  checkIcon: { width: '18px', height: '18px', color: '#10b981' },
  termsText: { fontSize: '0.9rem', color: '#cbd5e1', lineHeight: 1.5 },
  termsLink: { color: '#3b82f6', textDecoration: 'none', fontWeight: 500 },
  submitButton: {
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  footerLink: { fontSize: '0.95rem', color: '#3b82f6', textDecoration: 'none', fontWeight: 600 },
};
